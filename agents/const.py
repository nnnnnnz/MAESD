...
def get_metagpt_package_root():
    ...
    package_root = Path(agents.__file__).parent.parent
...
TOOL_SCHEMA_PATH = METAGPT_ROOT / "agents/tools/schemas"
TOOL_LIBS_PATH = METAGPT_ROOT / "agents/tools/libs"
